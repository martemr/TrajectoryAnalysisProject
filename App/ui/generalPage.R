...
# Description : UI de la page "général"
##---------------------------------------------
...
generalPage <- function(input,output){
  tabPanel("Général",
    ...
    # Onglet : CONDITIONS
    #==========================================
    sidebarPanel(h3("Parametres d'étude"),
                 ...
                 # Données à afficher
                 checkboxGroupInput("dataToPrintGeneral",
                 ...
                 # Message d'attente
                 conditionalPanel("!(input.dataToPrintGeneral.includes('1') || input.dataToPrintGeneral.includes('2') || input.dataToPrintGeneral.includes('3'))",
                                  p('Veuillez selectionner une donnée à afficher.')
                                 ), 
      
                 # Informations
                 conditionalPanel("input.dataToPrintGeneral.includes('1')",
                                  h4("Informations"),
